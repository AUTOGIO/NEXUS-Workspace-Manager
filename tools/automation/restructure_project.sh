...
# 🏗️ NEXUS Project Restructuring Script
...
echo "${BLUE}🏗️  NEXUS Project Restructuring Script${NC}"
echo "=============================================="
echo ""
...
echo ""
echo "${BLUE}📦 Moving Python files to new structure...${NC}"
echo ""

# Move Python files to src/nexus
if [ -f "src/nexus/dashboard/interactive_dashboard.py" ]; then
    echo "${YELLOW}⚠️  Dashboard already in new location${NC}"
else
    move_file "src/nexus/dashboard/interactive_dashboard.py" "src/nexus/dashboard/interactive_dashboard.py"
fi

if [ -f "src/nexus/core/ai_model_manager.py" ]; then
    echo "${YELLOW}⚠️  AI model manager already in new location${NC}"
else
    move_file "src/nexus/core/ai_model_manager.py" "src/nexus/core/ai_model_manager.py"
fi

if [ -f "src/nexus/core/dynamic_layout_manager.py" ]; then
    echo "${YELLOW}⚠️  Dynamic layout manager already in new location${NC}"
else
    move_file "src/nexus/core/dynamic_layout_manager.py" "src/nexus/core/dynamic_layout_manager.py"
fi
...
if [ -d "configs" ]; then
    echo "${YELLOW}⚠️  Configs directory already exists${NC}"
else
...
if [ -f "requirements.txt" ]; then
    move_file "requirements.txt" "requirements/requirements.txt"
fi

if [ -f "requirements-dev.txt" ]; then
    move_file "requirements-dev.txt" "requirements/requirements-dev.txt"
fi
